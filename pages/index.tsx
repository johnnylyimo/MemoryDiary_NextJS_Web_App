          ...
          {/* Edit Popup */}
            ...
            editMemoryPopUp ? (
              <div className="absolute top-[35%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-[#E1BEE7] w-[90%]  md:w-[45%]  flex justify-center items-center flex-col rounded-lg shadow-xl h-auto p-2 mx-auto">
              {
                ...
                <label htmlFor='emptyMemory' className='inline-block mb-1 text-md font-medium text-white'>
                </label>:<label htmlFor='memory' className='inline-block mb-1 text-md font-medium'>
                </label>
             }
                ...
                <div className="w-full flex justify-around">
                  <button type="submit" className='my-5 w-auto px-8 h-10 bg-red-600 font-semibold text-white t rounded-md shadow-md hover:shadow-lg'  onClick={()=>setEditMemoryPopUp(false)}>
                    Delete
                  </button>
