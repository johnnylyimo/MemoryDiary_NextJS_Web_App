            ...
            editMemoryPopUp ? (
              <div className="absolute top-[35%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-[#E1BEE7] w-[90%]  md:w-[45%]  flex justify-center items-center flex-col rounded-lg shadow-xl h-auto p-2 mx-auto">
                ...
                <div className="w-full flex justify-around">
                  ...
                  <button type="submit" className='flex items-center my-5 w-auto px-8 h-10 bg-blue-600 text-white font-semibold rounded-md shadow-md ' onClick={()=>submitEditMemory()}>
                    Save
                  </button>
